...
```{r echo=FALSE, fig.cap="View across Michigamme Highlands"}
...
ggplot(BPS_NAME_CHOP, aes(x = reorder(BPS_NAME, ACRES), y = ACRES)) + 
  ...
  labs(title = "Top 9 Historical Ecosystems of the Michigamme Highlands", 
       subtitle = "Area dominated by northern hardwoods types", 
...
## 
There are 75 Existing Vegetation Types mapped in the Michigamme Highlands. However, all ecosystems beyond the top 9 comprise less than 2% each of the MH, so have been omitted from the graph (>86% of the acerage was greater than 2% and is represented in the graph). 
...
ggplot(EVT_NAME_CHOP, aes(x = reorder(EVT_200_NAME, ACRES), y = ACRES)) + 
  ...
  labs(title = "top 9 Current Ecosystems of the Michigamme Highlands", 
       subtitle = "Area still dominated by northern hardwoods types", 
